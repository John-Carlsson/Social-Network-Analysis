    ...
    while not done and time < step:
        ...
        for i in G.nodes():
            for j in G[i]:
                ...
                tmp[j] += float(rank[i]*s)/G.degree(i)
...
#For semplicity let us assume that the number j of jobs is a perfect square (4, 9, 16, ...)
...
#As an example. If j = 4, the directed graph G defined by the following directed edges: (x,y), (x,z), (x,w), (y,x), (y,w), (z,x), (w,y), (w,z)
